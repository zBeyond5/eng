...
def enviar_mensagem(numero, mensagem, arquivo_pdf):
    try:
        ...
        if cargo:
            mensagem = f"{get_saudacao()}! Vi a vaga de emprego para {cargo} e acredito que meu perfil pode se encaixar bem. Em anexo, envio meu currículo para sua análise."
...
default_message = f"{get_saudacao()}! Vi a vaga de emprego e acredito que meu perfil pode se encaixar bem. Em anexo, envio meu currículo para sua análise."
